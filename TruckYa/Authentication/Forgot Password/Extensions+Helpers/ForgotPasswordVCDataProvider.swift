//
//  ForgotPasswordVCDataProvider.swift
//  TruckYa
//
...
extension ForgotPasswordVC {
    internal func callForgotPasswordSequence(for email:String) {
        ForgotPasswordAPI.shared.forgotPassword(for: email) { (data, serviceError, error) in
            if let error = error {
