...
//        pageCountLabel.centerYAnchor.constraint(equalTo: customerImageView.centerYAnchor).activate()
        ...
        nameTextField.anchor(top: customerImageView.bottomAnchor, left: scrollView.leftAnchor, bottom: nil, right: scrollView.rightAnchor, topConstant: view.frame.height / 11, leftConstant: padding, bottomConstant: 0, rightConstant: padding, widthConstant: width, heightConstant: height)
...
extension CustomerSignupVC: UIScrollViewDelegate {
