//
//  UpdateLicenseDataProvider.swift
//  TruckYa
//
...
extension DriverSignupVCForm4 {
    internal func callUpdateLicenseSequence(imageURL:String, imageData:Data, userId:String, licenseNumber: String, issueDate: String, voidDate: String) {
        UpdateLicenseAPI.shared.updateLicenseInfo(imageURL: imageURL, imageData: imageData, userId: userId, licenseNumber: licenseNumber, issueDate: issueDate, voidDate: voidDate) { (data, serviceError, error) in
            if let error = error {
