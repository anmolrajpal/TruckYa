...
//    guard let url = URLSession.shared.constructURL(from: Config.EndpointConfig.baseURL) else {
...
class CheckoutViewController: UIViewController {
    ...
    var stripePublishableKey = Config.PaymentConfig.stripeKey
    ...
    var backendBaseURL: String? = "https://seg-stripe-example.herokuapp.com"
