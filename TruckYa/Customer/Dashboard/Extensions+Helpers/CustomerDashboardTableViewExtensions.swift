//
//  CustomerDashboardTableViewExtensions.swift
//  TruckYa
//
...
extension CustomerDashboardVC: UITableViewDelegate {
...
extension CustomerDashboardVC: UITableViewDataSource {
...
//                    }
    ...
    //        let headerView = tableView.dequeueReusableHeaderFooterView(withIdentifier: NSStringFromClass(MenuTableViewHeaderView.self)) as! MenuTableViewHeaderView
    //
    //        return headerView
    //    }
