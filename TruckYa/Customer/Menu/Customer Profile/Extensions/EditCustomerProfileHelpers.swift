//
//  EditCustomerProfileHelpers.swift
//  TruckYa
//
...
extension EditCustomerProfileVC {
    ...
    @objc func didTapSaveButton() {
        ...
        if let name = self.subView.nameTextField.text,
            ...
            self.callUpdateProfileSequence(userId: UserDefaults.standard.userID!, fullName: name, phoneNumber: phoneNumber, address: address, city: city, state: state, country: country, postalCode: zipCode)
        } else {
