...
class CustomerProfileView: UIView {
    ...
    //        horizontalLine.anchor(top: nameLabel.bottomAnchor, left: scrollView.leftAnchor, bottom: nil, right: scrollView.rightAnchor, topConstant: 45, leftConstant: 56, bottomConstant: 0, rightConstant: 56, widthConstant: 0, heightConstant: 0.9)
            ...
            postalCodeLabelContainerView.anchor(top: countryLabelContainerView.bottomAnchor, left: emailLabelContainerView.leftAnchor, bottom: scrollView.bottomAnchor, right: emailLabelContainerView.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 40, rightConstant: 0, widthConstant: 0, heightConstant: height)
