...
//        containerImageView.transform = CGAffineTransform(translationX: 0, y: frame.height)
    ...
    fileprivate func setupContainerImageViewConstraints() {
        ...
        declineButton.bottomAnchor.constraint(equalTo: containerImageView.bottomAnchor).isActive = true
...
//        setNeedsLayout()
    ...
    lazy var declineButton:UIButton = {
        ...
        button.addTarget(self, action: #selector(huh), for: .touchUpInside)
        return button
    }()
    @objc func huh() {
        print("jhih")
