...
import Foundation
struct ServicesCodable : Codable {
    ...
    struct Datum : Codable {
        ...
        struct Userservice : Codable {
            ...
            let onedriverhelpsupload : Float?
            let stopanddrop : Float?
            let trailerhitchmove : Float?
            let twodriverhelpsupload : Float?
            ...
            init(from decoder: Decoder) throws {
                ...
                onedriverhelpsupload = try values.decodeIfPresent(Float.self, forKey: .onedriverhelpsupload)
                ...
                twodriverhelpsupload = try values.decodeIfPresent(Float.self, forKey: .twodriverhelpsupload)
