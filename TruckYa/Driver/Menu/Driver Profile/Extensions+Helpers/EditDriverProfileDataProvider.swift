//
//  EditDriverProfileDataProvider.swift
//  TruckYa
//
...
extension EditDriverProfileViewController {
    ...
    internal func callUpdateProfileSequence(userId:String, fullName:String, phoneNumber:String, address:String, city:String, state:String, country:String, postalCode:String, description:String) {
     UpdateProfileAPI.shared.update(userId: userId, fullName: fullName, mobileNo: phoneNumber, city: city, address: address, state: state, country: country, postalCode: postalCode, about: description) { (data, serviceError, error) in
            if let error = error {
