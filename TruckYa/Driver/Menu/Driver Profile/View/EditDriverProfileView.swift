...
class EditDriverProfileView: UIView {
    ...
    internal func configureView(withDriverDetails details:DriverProfile) {
        ...
        aboutTextView.text = details.description
    }
...
//        let calculatedWidth:CGFloat = frame.width - (padding * 2)
        ...
        aboutTextView.anchor(top: zipCodeTextFieldContainerView.bottomAnchor, left: nil, bottom: nil, right: nil, topConstant: 20, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: width - 40, heightConstant: 140)
        aboutTextView.centerXAnchor.constraint(equalTo: centerXAnchor).activate()
        
        saveButton.anchor(top: aboutTextView.bottomAnchor, left: nil, bottom: scrollView.bottomAnchor, right: nil, topConstant: 30, leftConstant: 0, bottomConstant: 40, rightConstant: 0, widthConstant: saveButtonSize, heightConstant: saveButtonSize)
    ...
    static func createTextField(placeholder:String? = nil) -> UITextField {
        ...
        if let placeholderText = placeholder {
            textField.attributedPlaceholder = NSAttributedString(string: placeholderText, attributes: [.foregroundColor: UIColor.lightText])
        }
    ...
    func createTextFieldContainerView(labelTitle:String, _ textField:UITextField) -> UIView {
        ...
        let separator = Line(color: .darkGray)
...
extension EditDriverProfileView: UITextViewDelegate {
