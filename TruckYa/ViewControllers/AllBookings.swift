        ...
        struct Booking : Codable {
            ...
            struct Driver : Codable {
                    ...
                    init(from decoder: Decoder) throws {
                            ...
                            longField = try values.decodeIfPresent(Float.self, forKey: .longField)
...
//                            transferGroup = try values.decodeIfPresent(AnyObject.self, forKey: .transferGroup)
                ...
                struct Source : Codable {
                        ...
                        let addressCity : AnyObject?
                        let addressCountry : AnyObject?
                        let addressLine1 : AnyObject?
                        let addressLine1Check : AnyObject?
                        let addressLine2 : AnyObject?
                        let addressState : AnyObject?
                        let addressZip : AnyObject?
                        let addressZipCheck : AnyObject?
                        let brand : String?
                        let country : String?
                        let customer : String?
                        let cvcCheck : AnyObject?
                        let dynamicLast4 : AnyObject?
                        let expMonth : Int?
                        let expYear : Int?
                        ...
                        let name : AnyObject?
                        let object : String?
                        let tokenizationMethod : AnyObject?
                        ...
                        init(from decoder: Decoder) throws {
                                let values = try decoder.container(keyedBy: CodingKeys.self)
                                addressCity = try values.decodeIfPresent(AnyObject.self, forKey: .addressCity)
                                addressCountry = try values.decodeIfPresent(AnyObject.self, forKey: .addressCountry)
                                addressLine1 = try values.decodeIfPresent(AnyObject.self, forKey: .addressLine1)
                                addressLine1Check = try values.decodeIfPresent(AnyObject.self, forKey: .addressLine1Check)
                                addressLine2 = try values.decodeIfPresent(AnyObject.self, forKey: .addressLine2)
                                addressState = try values.decodeIfPresent(AnyObject.self, forKey: .addressState)
                                addressZip = try values.decodeIfPresent(AnyObject.self, forKey: .addressZip)
                                addressZipCheck = try values.decodeIfPresent(AnyObject.self, forKey: .addressZipCheck)
                                brand = try values.decodeIfPresent(String.self, forKey: .brand)
                                country = try values.decodeIfPresent(String.self, forKey: .country)
                                customer = try values.decodeIfPresent(String.self, forKey: .customer)
                                cvcCheck = try values.decodeIfPresent(AnyObject.self, forKey: .cvcCheck)
                                dynamicLast4 = try values.decodeIfPresent(AnyObject.self, forKey: .dynamicLast4)
                                ...
                                object = try values.decodeIfPresent(String.self, forKey: .object)
                                tokenizationMethod = try values.decodeIfPresent(AnyObject.self, forKey: .tokenizationMethod)
                        }
